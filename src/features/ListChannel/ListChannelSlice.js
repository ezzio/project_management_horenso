...
const initialState = {
  workspace: ["Project Ideas", "Confirm Content", "Waiting for review"],
  teams: ["Developers", "Designer"],
  others: ["Off-Topic", "Archive"],
  members: ["Dang Khoa", "Huu Thang", "Chanh Nhut", "Phu Nguyen", "Tuong Minh"],
};
...
export const { addWorkspaceChannel, addTeamsChannel, addOthersChannel } =
