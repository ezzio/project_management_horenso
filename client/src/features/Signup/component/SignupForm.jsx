  ...
  return (
    <form className="signup-form" onSubmit={handleSubmit(onHandleSubmit)}>
      ...
      <div className="signup-form__confirm-password-container">
        <span className="signup-form__confirm-password-container__label">
          Confirm password
        </span>
        <div className="confirm-password-textbox">
          <input
            className="confirm-password-textbox__input"
            placeholder="*****"
      ...
      <div className="signup-form__password-container">
        <span className="signup-form__password-container__label">
          Choose Password
        </span>
        <div className="password-textbox">
          ...
          {isShow ? (
            <BiHide
              className="password-textbox__hide-password"
              onClick={() => toggleShow()}
              style={{ fontSize: 25 }}
            />
          ) : (
        ...
        {errors.password && (
          <p
            style={{ position: "absolute", top: 42, fontSize: 12 }}
            className="signup-form__error"
          >
      ...
      <div className="signup-form__fullname-container">
        ...
        <div className="fullname-textbox">
          <input
            className="fullname-textbox__input"
        ...
        {errors.fullName && (
          <p
            style={{ position: "absolute", top: 127, fontSize: 12 }}
            className="signup-form__error"
          >
      ...
      <a className="signup-form__login-github" href="https://www.google.com">
        or signup with Github
      </a>
      <span className="signup-form__footer">
